            ...
            cancel: match self.cancel.as_option() {
                Some(v) => {
                    ::buffa::MessageField::<
                        ...
                        ::buffa::Inline<super::super::client_compat_request::Cancel>,
                    >::some(v.to_owned_from_source(__buffa_src)?)
                }
                None => ::buffa::MessageField::none(),
            },
            raw_request: match self.raw_request.as_option() {
                Some(v) => {
                    ::buffa::MessageField::<
                        ...
                        ::buffa::Inline<super::super::RawHTTPRequest>,
                    >::some(v.to_owned_from_source(__buffa_src)?)
                }
                None => ::buffa::MessageField::none(),
            },
    ...
    fn merge_view_field(
        ...
        match tag.field_number() {
            ...
            2u32 => {
                ...
                ctx.register_element_memory(
                    ::core::mem::size_of::<
                        super::super::__buffa::view::ConformancePayloadView,
                    >(),
                )?;
                view.payloads
                    .push(
